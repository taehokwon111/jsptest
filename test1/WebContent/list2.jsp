			...
			<section>
				...
				<div class="index-txt">
					<table>
						...
						<%
							String sql = "select AA.scode, TSH.sname, AA.SHAP from (select TSALE.scode, SUM(TPRO.cost * tsale.amount) as SHAP from tbl_salelist_01 TSALE join tbl_product_01 TPRO on TSALE.pcode = TPRO.pcode GROUP BY TSALE.scode)AA join tbl_shop_01 TSH on AA.scode = TSH.scode";
